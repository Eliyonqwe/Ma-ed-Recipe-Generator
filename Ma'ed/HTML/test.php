                ...
                <form action="" method="post">
                    ...
                    <div class="main">
                        ...
                        <article class="article">
                            ...
                            <ul id="sortType">
                                <li><button type="submit" name="sortName" class="sortbtn">Name</button></li>
                                <li> <button type="submit" class="sortbtn">Type</button></li>
                            </ul>
                            ...
                            if (isset($_POST["sortName"])) {
                                ...
                                $id_list = (count($_SESSION['array']) < 2) ? implode('', $_SESSION['array']) : implode(',', $_SESSION['array']);

                                // Build the SQL query
                                $sql = "SELECT * FROM food WHERE foodID IN ($id_list) order by foodName ";
                    ...
                    ?>
                            ...
                            <?php
                                ...
                                displayDiv($result); //a function that displays results written at the start of <body> tag
