...
<html lang="en">
  ...
  <body>
        ...
        <header class="header">
          ...
          <section class="navigation">
            ...
            <ul>
              ...
              <li id="normal">
                <a href="#"
                  ><span class="material-symbols-outlined">groups</span> About
                  Us</a
                >
              </li>
              <li id="normal">
    ...
    <div class="wrapper2">
      <h1>Tibs</h1>
      <p id="information">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius ab suscipit dolorum, obcaecati doloribus vero quidem laboriosam ipsam rerum magni?</p>
        ...
        <div class="ingredient-info">
          ...
          <div class="instructions">
            ...
            <ol>
              ...
              <li>Add the beef cubes to the skillet and cook until they are browned on all sides.</li>                <li>Add the chopped tomatoes and jalapeno peppers to the skillet and stir well.</li> 
